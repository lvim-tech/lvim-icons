...
--- no svg mapping (the resolver then falls back to the font glyph for it). Sequences are
--- stored as codepoint lists and materialised with nr2char (the same discipline as font
--- glyphs) so the source data survives editing.
